...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "O6wQlYIb#iX4CjZ3t7qbXyFKfxbWN_vYJAgp0P2XOaifBld-g0Os",
    ...
    AUTO_STATUS__MSG: process.env.AUTO_STATUS__MSG || "`𝒚𝒐𝒖𝒓 𝒔𝒕𝒂𝒕𝒖𝒔 𝒔𝒆𝒆𝒏 𝒋𝒖𝒔𝒕 𝒏𝒐𝒘 𝒃𝒚 Tanaka`",
